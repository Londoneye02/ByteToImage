...
int[] byteImagenes = new int[] {
   ...
   0xf8, 0xfa, 0x01, 0x3c, 0x80, 0x03, 0x0e, 0x07, 0x07, 0xc3, 0x3f, 0x0e,
   0xf1, 0xf0, 0x08, 0x38, 0xc0, 0x01, 0x18, 0x8f, 0x01, 0xc0, 0x3f, 0x00,
   0xc0, 0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x0f, 0x00,
...
*/
            ...
            for (int i = 0; i < ImageBytes; i++)
            {
                for (int j = 0; j < 8; j++)
                {
                    ...
                    {
                        CreateBox(columnCounter, rowCounter,3 , true);
                    }
                    else
                    {
                        CreateBox(columnCounter, rowCounter, 3, false);
                    }
                    ++columnCounter;
